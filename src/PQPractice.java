...
public class PQPractice {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> nums = List.of(33, 2, 5, 77, 3, 8, 99, 1, 2, 55, 2, 5, 6, 33, 2);
        System.out.println(topK(nums, 4));
    }

    // Return the top K elements in the list - Pass in a k of 5, it will give us the 5 biggest numbers in the list
